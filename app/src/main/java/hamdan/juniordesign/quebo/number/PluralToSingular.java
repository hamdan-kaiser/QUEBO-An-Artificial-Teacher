package hamdan.juniordesign.quebo.number;
...
public class PluralToSingular {
    ...
    protected static final PluralToSingular INSTANCE = new PluralToSingular();
    /**
    ...
    public PluralToSingular() {
        initialize();
    }

    protected PluralToSingular(PluralToSingular original) {
    ...
    public static final PluralToSingular getInstance() {
        return INSTANCE;
    }
    ...
    @Override
    public PluralToSingular clone() {
        return new PluralToSingular(this);
    }
    ...
    /**
     * Completely remove all rules within this PluralToSingular.
     */
    public void clear() {
